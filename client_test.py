...
class ClientTest(unittest.TestCase):
    ...
    def test_getRatio_priceBIsZero(self):
        quotes = [
            {'top_ask': {'price': 119.28, 'size': 36}, 'timestamp': '2019-02-11 22:06:30.572453',
             'top_bid': {'price': 120.4, 'size': 109}, 'id': '0.109974697771', 'stock': 'ABC'},
            {'top_ask': {'price': 0, 'size': 4}, 'timestamp': '2019-02-11 22:06:30.572453',
             'top_bid': {'price': 0, 'size': 81}, 'id': '0.109974697771', 'stock': 'DEF'}
        ]
        for quote in quotes:
            self.assertRaises(ZeroDivisionError, msg="cannot divide by 0")
